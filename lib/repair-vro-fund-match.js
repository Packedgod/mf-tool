...
export async function repairValueResearchFundMatch(inputResearch, fund) {
  ...
  if (!discovery.ok) {
    return {
      ...
      current: {
        ...research.current,
        valueResearch: null,
        holdings: research.current?.moneycontrol?.holdings?.length
          ? research.current.moneycontrol.holdings
          : research.current?.advisorKhoj?.holdings || research.current?.holdings || [],
        sectors: research.current?.moneycontrol?.sectors?.length
          ? research.current.moneycontrol.sectors
          : research.current?.advisorKhoj?.sectors || research.current?.sectors || [],
  ...
  return {
    ...
    current: {
      ...
      holdings: valueResearch.holdings?.length
        ? valueResearch.holdings
        : research.current?.moneycontrol?.holdings?.length
          ? research.current.moneycontrol.holdings
          : research.current?.advisorKhoj?.holdings || [],
      sectors: research.current?.moneycontrol?.sectors?.length ? research.current.moneycontrol.sectors : research.current?.sectors || [],
      assetAllocation: valueResearch.assetAllocation?.length ? valueResearch.assetAllocation : research.current?.moneycontrol?.assetAllocation || [],
      marketCap: valueResearch.marketCap?.length ? valueResearch.marketCap : research.current?.moneycontrol?.marketCap || [],
