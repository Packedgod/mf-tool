...
export function detailedMomentumSchemeId(fund) {
  ...
  if (text.includes("icici prudential multi asset")) return "icici-multi-asset";
  if (text.includes("icici prudential india opportunities")) return "icici-india-opportunities";
  if (text.includes("icici prudential business cycle")) return "icici-business-cycle";
  return null;
}
